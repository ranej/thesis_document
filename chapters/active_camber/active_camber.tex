...
In this section, we focus on high Reynolds number flow with $Re=1,000,000$ and at a higher angle of attack of $\alpha=10^\circ$. Two very high (sectional) advance ratios of $\mu_{sect}= 1.5$ and $2.0$ are considered. 
