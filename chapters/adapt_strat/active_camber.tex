...
%TODO: may be we consider non-adapted mesh for  Re=40k and 200k with 10 AoA and 2 high advance ratios of 1.5 and 2.0 ... so that adaptive LES can be shown for high advance ratio (baseline and active camber cases) at Re=40k and 200k ... for thesis keep Re=1m at mu=1.5 and 2.0 with non-adapted mesh for both baseline and active camber ... and may be drop adaptive LES with Re=40k, 10 AoA, mu=1.5 for both baseline and active camber... though it will be nice to show adaptive LES for a high advance ratio and/or an active camber cas)
