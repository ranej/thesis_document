...
\include{chapters/Introduction/Introduction} % chapter 1

\include{chapters/LES/numerical_discretization} % chapter 2
\label{chap:num_disc}

\include{chapters/VMS_EE/VMS_EE}
\label{chap:vms_ee}

\include{chapters/adapt_strat/baseline_results}
\label{chap:baseline_results}

%\include{chapters/adapt_strat/Adapt_St}
%\label{chap:adapt_strat}

\include{chapters/zonal_adapt_results/zonal_adapt_results}
\label{chap:zonal_adapt_results}

\include{chapters/active_camber/active_camber}
\label{chap:active_camber}

\include{chapters/closing_remarks/closing_remarks}
